...
public class SmsFlutterPlugin: NSObject, FlutterPlugin, UINavigationControllerDelegate, MFMessageComposeViewControllerDelegate {
    var result: FlutterResult?
    var _arguments = [String: Any]()

  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "plugins.elyudde.com/sendSMS", binaryMessenger: registrar.messenger())
    let instance = SmsFlutterPlugin()
